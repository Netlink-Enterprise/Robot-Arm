final_readme_format = """# Robotic Arm Project (Mini Servos & OpenSCAD)
...
- **Building a 4-Axis Robotic Arm | Complete CAD Design & Engineering Process:** [Watch on YouTube](http://www.youtube.com/watch?v=3MLM6M7kHH0) 
...
with open("README.md", "w", encoding="utf-8") as f:
    f.write(final_readme_format)

print("Generated final README.md with citations.")
